...
namespace Drill06.Migrations
{
    ...
    public partial class AddSoftDeleteFields : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Students",
                columns: new[] { "Id", "CreatedAt", "DeletedAt", "Email", "FullName", "IsActive", "IsDeleted" },
                values: new object[,]
                {
                    { 1, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "rowida@gmail.com", "Rowida Gamal", true, false },
                    { 2, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "arwaa@gmail.com", "Arwa Ali", true, false },
                    { 3, new DateTime(2026, 1, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "hassan@gmail.com", "Hassan Mohamed", true, false },
                    { 4, new DateTime(2026, 1, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "gamal@gmail.com", "Gamal Hassan", true, false },
                    { 5, new DateTime(2026, 1, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "mona@gmail.com", "Mona Ali", true, false }
                });
