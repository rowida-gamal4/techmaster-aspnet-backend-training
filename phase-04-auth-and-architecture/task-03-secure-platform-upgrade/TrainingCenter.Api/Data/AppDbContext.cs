...
namespace TrainingCenter.Api.Data
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TrackSession>()
                .HasOne(s => s.CreatedByInstructor)
                .WithMany(i => i.CreatedSessions)
            ...
            modelBuilder.Entity<TrainingTrack>().Property(t => t.Price).HasDefaultValue(2000m);

            //
            modelBuilder.Entity<Enrollment>().HasIndex(e => new { e.StudentId, e.TrainingTrackId }).IsUnique().HasFilter("[Status] = 0");
